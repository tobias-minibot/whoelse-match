...
const workers: Entity[] = [
  ...
  worker("worker-cleo-hart", "Cleo Hart", DC, {
    ...
    offers: ["product design", "can do this work for under $5,000", "landing pages"],
  ...
  worker("worker-pia-shore", "Pia Shore", DC, {
    ...
    offers: ["weekend gig", "can do this work", "local task"],
    seeks: ["weekend work"],
    rate: 500,
...
const jobAgents = [
  ...
  jobAgent(
    "agent-budgetcoder",
    "BudgetCoder",
    ["can do this work", "can do this work for under $5,000", "cheap coding", "project under $5000"],
    ["budget tasks"],
